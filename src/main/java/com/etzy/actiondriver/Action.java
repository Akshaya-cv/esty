...
public class Action extends Baseclass  {
	...
	public static void scrollByVisibilityOfElement(Object object, WebElement ele) {
	 ...
	 * @return - true/false
	 */
	public static boolean type(WebElement ele, CharSequence[] i) {
		boolean flag = false;
		try {
			flag = ele.isDisplayed();
			ele.clear();
	...
	public static boolean JSClick(Object object, WebElement ele) {
		boolean flag = false;
		try {
	...
	public static void sleep(Object driver, WebElement searchbutton) {
